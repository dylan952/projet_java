...
public class Cal2 extends JPanel {
  ...
  protected String[] months =  { "Janvier ", "Fevrier ", "Mars ", "Avril ", "Mai ", "Juin",
    ...
    JButton btnPrevious = new JButton("<");
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(i == 0){
                ...
                int j = yearChoice.getSelectedIndex();
                yearChoice.setSelectedIndex(--j);
            }
            else{
                monthChoice.setSelectedIndex(--i);
            } 
        }
    });
