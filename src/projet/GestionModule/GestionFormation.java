...
public class GestionFormation extends JFrame {
    ...
    private JButton jButtonModifierFormation;
    private JButton jButtonModifierListe;
    private JButton jButtonValider;
    private JLabel jLabelDureeSeances;
    private JLabel jLabelListeModules;
    private JLabel jLabelNomFormation;
    private JList jListModules;
    private JScrollPane jScrollPane1;
    private JTextField jTextFieldDureeSeances;
    private JTextField jTextFieldNomFormation;
